...
var CONFIG = {
    ...
    author: "简云",
    version: "2.2.9",
    srcUrl: "https://gitee.com/janyun/music-free-plugin/raw/master/kugou.lite.js",
    primaryKey: ["id", "hash"],
...
var DataTransformer = {
    ...
    transformSong: function(item) {
        ...
        result.title = suffix ? mainName + ' ' + suffix : mainName;
...
var Service = {
    ...
    importMusicSheet: function(urlLike) {
        ...
        return Promise.resolve().then(function() {
            ...
            return Service.getMusicSheetInfo({ id: playlistId }, 1, 1000);
        }).then(function(data) {
